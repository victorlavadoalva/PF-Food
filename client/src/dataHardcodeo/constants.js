...
export const FOOD = [
    {
        id: 1,
        name: "Milanesa",
        description: "La milanesa es un filete, normalmente de carne vacuna, que se cocina frito o al horno. Por extensión, se llama milanesa a cualquier rebanada de un ingrediente rebozado y cocido de manera similar, por lo que existen milanesas de cerdo, de pollo, de pescado, de soja, de berenjena o de mozzarella, entre otros ingredientes",
        image: [
            require('./img/milanesa.jpeg').default
        ],
        tags: [
            "Vegetariana",
            "Apto celiacos"
...
export const reservasRows = [
    { id: 1, name: 'Snow', day: '26/04', hour: "20:45", quanty: 4, phone: 36546545 },
    { id: 2, name: 'Lannister', day: '26/04', hour: "20:45", quanty: 2, phone: 4564564564 },
    { id: 3, name: 'Lannister', day: '26/04', hour: "20:45", quanty: 3, phone: 3123123145 },
    { id: 4, name: 'Stark', day: '26/04', hour: "20:45", quanty: 5, phone: 1746743536 },
    { id: 5, name: 'Targaryen', day: '26/04', hour: "20:45", quanty: 4, phone: 65465654 },
    { id: 6, name: 'Melisandre', day: "26/04", hour: "20:45", quanty: 8, phone: 8798463541 },
    { id: 7, name: 'Clifford', day: '26/04', hour: "20:45", quanty: 4, phone: 654321354 },
    { id: 8, name: 'Frances', day: '26/04', hour: "20:45", quanty: 2, phone: 68576524163 },
    { id: 9, name: 'Roxie', day: '26/04', hour: "20:45", quanty: 6, phone: 65432132416 },
];
...
export const pedidosColumns = [
  ...
  export const pedidosRows = [
    { id: 1, name: 'Snow', adress: 'Av. San Martin 456', phone: 65465465, plate: ["Milanesas con papas"], status: true },
    { id: 2, name: 'Lannister', adress: '9 de Julio 789', phone: 45646546, plate: ["Milanesas con papas"], status: true },
    { id: 3, name: 'Lannister', adress: '25 de Mayo 452', phone: 2664498465, plate: ["Milanesas con papas"], status: false },
    { id: 4, name: 'Stark', adress: 'Mendoza 963', phone: 35265465, plate: ["Milanesas con papas"], status: true },
    { id: 5, name: 'Targaryen', adress: 'Los Treboles 852', phone: 798798, plate: ["Milanesas con papas"], status: false },
    { id: 6, name: 'Melisandre', adress: "Calle s/n 369", phone: 156546540, plate: ["Milanesas con papas"], status: true },
    { id: 7, name: 'Clifford', adress: 'La Pamapa 456', phone: 46465464, plate: ["Milanesas con papas"], status: false },
    { id: 8, name: 'Frances', adress: 'Belgrano 1938', phone: 87985465, plate: ["Milanesas con papas"], status: false },
    { id: 9, name: 'Roxie', adress: '25 de Agost0 333', phone: 968765463, plate: ["Milanesas con papas"], status: false },
  ];